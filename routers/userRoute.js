...
router.post("/admin/user/save", urlencodeParser, isAdminAllowed,insertUser);
router.get("/admin/user/edit/:id", isAdminAllowed, editUser);
router.post("/admin/user/update", urlencodeParser, isAdminAllowed, updateUser);
...
router.get("/admin/user/download", isAdminAllowed, downloadUsers);
...
router.get("/api/V1/checkfiles", apiCheckUserFiles);
