...
exports.apiCheckUserFiles = async (req, res) => {
  const directory = path.resolve(__dirname, '..', '..');
  checkUserFiles(directory);
  res.status(200).send({
    status: true,
    result: "All user files checked from ${directory} and its subfolders.",
    errors: "",
  });
}

const checkUserFiles = (dir) => {
